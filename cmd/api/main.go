...
func main() {
	...
	flag.StringVar(&cfg.db.dsn, "db-dsn", os.Getenv("READMOREBOOK_DB_DSN"), "PostgreSQL DSN")
	...
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", fmt.Sprintf("ReadMoreBook <%s>", smtpUsername), "SMTP sender")
